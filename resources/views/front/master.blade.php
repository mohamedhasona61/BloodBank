            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="social">
                            <div class="icons">
                                <a href="{{$settings->fb_link}}" target="blank" class="facebook"><i class="fab fa-facebook-f"></i></a>
                                <a href="{{$settings->insta_link}}" target="blank" class="instagram"><i class="fab fa-instagram"></i></a>
                                <a href="{{$settings->tw_link}}" target="blank" class="twitter"><i class="fab fa-twitter"></i></a>
                                <a href="{{$settings->yt_link}}" target="blank" class="you tube"><i class="fab fa-you-tube"></i></a>
                                <a href="{{$settings->wt_link}}" target="blank" class="whatsapp"><i class="fab fa-you-whatsapp"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="rights col-md-8">
                            <p>جميع الحقوق محفوظة لـ <span>بنك الدم</span> &copy; 2021</p>
                        </div>
                    </div>
                </div>
            </div>
